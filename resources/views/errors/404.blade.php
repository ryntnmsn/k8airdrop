...
<div class="flex items-center justify-center py-28" style="background-image:url({{url('images/404.png')}}); background-repeat:no-repeat; background-size:800px; background-position:center">
    <div>
        ...
        <div class="mt-10">
            <a class="block bg-[#a38e5c] fw-bold text-slate-100 py-2 rounded-full text-center hover:-translate-y-1 duration-500 hover:shadow-xl" href="/">{{ __('Go back to promos') }}</a>
        </div>
    </div>
