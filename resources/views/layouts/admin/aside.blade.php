<aside id="logo-sidebar" class="fixed top-0 left-0 z-30 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
      ...
      <ul class="space-y-2 font-medium">
         ...
         <li class="border-b border-slate-100">
            <a wire:navigate href="{{ route('carousel.index') }}" class=" flex items-center p-2 rounded-lg hover:bg-indigo-600 hover:text-slate-50 group">
               <div class="w-6">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
         ...
         <li class="border-b border-slate-100">
            <a wire:navigate href="#" class="flex items-center p-2 text-slate-800 rounded-lg hover:bg-indigo-600 hover:text-slate-50 group">
               <div class="w-6">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
