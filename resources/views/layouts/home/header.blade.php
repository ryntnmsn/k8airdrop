<header class="absolute top-0 w-full dark:bg-slate-100 bg-slate-900">
    ...
    <div>
        <div class="max-w-[1280px] px-5 w-full mx-auto flex justify-between items-center">
            ...
            <div class="flex-1">
                <ul class="flex justify-center items-center gap-10 text-lg font-semibold text-slate-200 dark:text-slate-600 cursor-pointer">
            ...
            <div class="flex-1">
                <div class="flex justify-end space-x-3">
                    <x-href href="" class="!bg-transparent !border-0 !font-semibold">Sign in</x-href>
                    <x-href href="" class="!bg-indigo-600 !border-indigo-600 !font-semibold">Sign up</x-href>
