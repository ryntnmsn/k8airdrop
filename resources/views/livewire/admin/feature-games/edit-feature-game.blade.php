<div>
    <div class="flex">
        <div class="flex-1 flex flex-col space-y-1">
            <x-title>Edit Featured Game</x-title>
        </div>
    </div>
    <div class="mt-10">
        <div class="flex">
            <form wire:submit.prevent='updateFeaturedGame' class="w-full space-y-8">
                <div>
                    ...
                    <div class="flex items-center justify-left w-full">
                        <label for="dropzone-file" class="overflow-hidden flex flex-col items-center justify-center w-96 h-96 border-2 border-slate-300 border-dashed cursor-pointer bg-slate-50">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6 relative">
                                ...
                                @else
                                    <img src="{{ url('storage/featured_games/', $old_image) }}" class="w-full rounded-xl"/>
                                @endif
                            </div>
                ...
                <div class="flex">
                    <x-button wire:target='updateFeaturedGame' type="submit" class="!float-none">Save</x-button>
