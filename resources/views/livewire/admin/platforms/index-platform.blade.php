                        ...
                        @foreach ($platforms as $platform)
                            <tr class="border-b hover:bg-slate-100 rounded-xl">
                                ...
                                <td class="px-6 py-3 float-left">
                                    <x-button wire:click="deletePlatform({{$platform->id}})" data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="!p-1 !bg-transparent !border-0 !text-rose-500 hover:!text-rose-600" >
