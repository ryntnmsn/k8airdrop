    ...
    <form wire:submit.prevent="storeArticleTag">
        <div class="p-4 md:p-5 space-y-4">
            <div>
                ...
                <x-input-text wire:model.live="articleTag.title"></x-input-text>
            </div>
        </div>
        <!-- Modal footer -->
                    ...
                    @foreach ($articleTags as $articleTag)
                        <tr class="border-b hover:bg-slate-100 rounded-xl">
                            ...
                            <td class="px-6 py-3 flex justify-end">
                                ...
                                <x-button wire:click="deleteArticleTag({{ $articleTag->id }})" data-modal-target="delete-modal" data-modal-toggle="delete-modal" class="!p-2 !bg-transparent !border-0 !text-slate-600" >
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <button wire:click="destroyArticleTag" data-modal-hide="delete-modal" class="text-white bg-rose-600 hover:bg-rose-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                    Yes, I'm sure
                </button>
