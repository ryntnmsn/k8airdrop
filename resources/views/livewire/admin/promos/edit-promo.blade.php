                            ...
                            <div class="flex-1 space-y-8">
                             ...
                             <div class="flex-none w-96 pt-8 xl:pt-0">
                                <div class="relative items-center justify-center w-full">
                                    <label class="overflow-hidden flex flex-col items-center justify-center w-full h-52 border-2 border-slate-300 border-dashed cursor-pointer bg-slate-50">
                                        <div class="flex flex-col items-center justify-center pt-5 pb-6 relative">
                                            @if($image != null)
                                                <img src="{{ url('storage/promos/' . $image) }}" class="w-full rounded-xl"/>
                                            @else
                                                <img src="{{ url('storage/promos/default-image.jpg') }}" class="w-full rounded-xl"/>
                                            @endif
                                        </div>
