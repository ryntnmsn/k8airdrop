        ...
        <div class="pb-10">
            <div class="flex flex-col lg:flex-row space-x-0 space-y-5 lg:space-y-0 lg:space-x-5 lg:items-center">
                <div class="p-1 rounded-lg flex-none">
                    <img src="{{ url('storage/promos/', $image) }}" alt="" class="w-32 rounded-lg">
                </div>
                <div class="flex flex-col">
                    <x-label class="!font-medium block !text-xl">{{ $name }}</x-label>
                    <x-label class="!text-slate-400 block !text-lg">
                        @if($is_visible == '1')
                            <span class="bg-green-100 text-green-500 font-medium px-2 rounded-full text-sm">Active</span>
                        @else
                            <span class="bg-rose-100 text-rose-500 font-medium px-2 rounded-full text-sm">Inactive</span>
                        @endif
                    </x-label>
                </div>
            </div>
