        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <form wire:submit.prevent="storeQuestion">
                <div class="p-4 md:p-6 space-y-4">
                    ...
                    <div>
                        @foreach ($inputs as $key => $value)
                            <div wire:key="{{ $key }}" class="add-input mb-4">
                                <div class="flex w-full items-center justify-between space-x-4">
                                    <div class="w-full">
                                        <x-input-text wire:model="inputs.{{ $key }}.choice"  class="!w-full"></x-input-text>
                                    </div>
                                    <div>
                                        <button wire:click="removeInputs({{$key}})" class="text-rose-500 px-3">
                ...
                <div class="flex items-center justify-between border-t p-4 md:p-6">
                    <x-button class="block !float-none !bg-transparent !text-indigo-500 !hover:text-indigo-600 !border-indigo-500" wire:click="addInputs">Add options</x-button>
