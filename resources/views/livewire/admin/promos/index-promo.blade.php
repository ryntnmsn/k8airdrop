                            ...
                            <tr class="border-b hover:bg-slate-100 rounded-xl">
                                ...
                                <td class="px-6 py-3">
                                    <div class="flex flex-row gap-3">
                                        ...
                                        <x-href href="{{ route('promos.edit', $promo->id) }}" class="!p-1 !bg-transparent !border-0 !text-slate-600 hover:!text-indigo-500" >
                                        ...
                                        <x-button wire:click="deletePromo({{$promo->id}})" data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="!p-1 !bg-transparent !border-0 !text-slate-600 hover:!text-slate-900" >
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
