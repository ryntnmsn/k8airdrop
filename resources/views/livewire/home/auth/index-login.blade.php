                ...
                <div>
                    ...
                    <div class="mb-8">
                        <div class="relative">
                            ...
                            <x-input-text wire:model.live="k8_username" class="!bg-slate-800 border-none !text-slate-200 !ps-12 !p-4 font-bold focus:ring-indigo-600 focus:ring-2 placeholder-slate-600" placeholder="Enter K8 username"></x-input-text>
                        </div>
                        @error('k8_username')
                  ...
                  {{-- Password --}}
                    <div class="mb-8">
                        <div class="relative">
                            ...
                            <x-input-text type="password" wire:model.live="password"  class="!bg-slate-800 border-none !text-slate-200 !ps-12 !p-4 font-bold focus:ring-indigo-600 focus:ring-2 placeholder-slate-600" placeholder="Enter password"></x-input-text>
                        </div>
                        @error('password')
                            <span class="text-sm text-rose-500 pt-2 block">{{ $message }}</span>
                        @enderror
