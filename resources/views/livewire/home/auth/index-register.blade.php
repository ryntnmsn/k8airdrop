                ...
                <div>
                    ...
                    <div class="mb-8">
                        <div class="relative">
                            ...
                            <x-input-text wire:model.live="name" class="!bg-slate-800 border-none !text-slate-200 !ps-12 !p-4 font-bold focus:ring-indigo-600 focus:ring-2 placeholder-slate-600" placeholder="{{ __('Enter nick name') }}"></x-input-text>
                        </div>
                        @error('name')
