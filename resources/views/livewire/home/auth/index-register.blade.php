                ...
                <div>
                    ...
                    <div class="mb-8">
                        <div class="relative">
                            ...
                            <x-input-text wire:model.live="name" class="!bg-slate-800 border-none !text-slate-200 !ps-12 !p-4 font-bold focus:ring-amber-100 focus:ring-2 placeholder-slate-600" placeholder="{{ __('Enter nickname') }}"></x-input-text>
                        </div>
                        @error('name')
                    ...
                    <div class="mb-8">
                        <div class="relative">
                            ...
                            <x-input-text wire:model.live="email" class="!bg-slate-800 border-none !text-slate-200 !ps-12 !p-4 font-bold focus:ring-amber-100 focus:ring-2 placeholder-slate-600" placeholder="{{ __('Enter email') }}"></x-input-text>
                        </div>
                        @error('email')
                            <span class="text-sm text-rose-500 pt-2 block">{{ __($message) }}</span>
                        @enderror
                    ...
                    <div class="mb-8">
                        <div class="relative">
                            ...
                            <x-input-text wire:model.live="k8_username" class="!bg-slate-800 border-none !text-slate-200 !ps-12 !p-4 font-bold focus:ring-amber-100 focus:ring-2 placeholder-slate-600" placeholder="{{ __('Enter K8 username') }}"></x-input-text>
                        </div>
                        <div class="mt-2">
                  ...
                  {{-- Password --}}
                    <div class="mb-8">
                        <div class="relative">
                            ...
                            <x-input-text type="password" wire:model.live="password" class="!bg-slate-800 border-none !text-slate-200 !ps-12 !p-4 font-bold focus:ring-amber-100 focus:ring-2 placeholder-slate-600" placeholder="{{ __('Enter password') }}"></x-input-text>
                        </div>
                        @error('password')
                            <span class="text-sm text-rose-500 pt-2 block">{{ __($message) }}</span>
                        @enderror
                    ...
                    <div class="mb-8">
                        <div class="relative">
                            ...
                            <x-input-text type="password" wire:model.live="password_confirmation" name="password_confirmation" class="!bg-slate-800 border-none !text-slate-200 !ps-12 !p-4 font-bold focus:ring-amber-100 focus:ring-2 placeholder-slate-600" placeholder="{{ __('Confirm password') }}"></x-input-text>
                        </div>
                    </div>
