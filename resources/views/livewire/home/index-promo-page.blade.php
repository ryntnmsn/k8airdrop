     ...
     <div wire:ignore.self id="containerFilter" class="hidden mb-10 p-5 bg-slate-900 rounded-xl">
         <div class="flex flex-col md:flex-row gap-10">
             <div class="flex-1">
                 ...
                 <div class="relative">
                     <x-input-text wire:model.live="searchPromo" placeholder="Enter text here.." class="!text-slate-200 bg-slate-800/[.50] !border-slate-800 focus:!ring-amber-100 placeholder-slate-700"></x-input-text>
