    ...
    <div class="flex gap-10 h-full">
        ...
        <div class="w-[80%]">
            <div class="flex items-center justify-between pb-8">
                <div>
                    <h1 class="text-slate-200 text-3xl font-semibold border-b border-slate-900">Spin the Wheel <span class="text-xl"></span></h1>
                </div>
                <div>
                    <x-href href="{{ route('spin.wheel') }}" class="!font-semibold">Spin now</x-href>
                </div>
            </div>
            <div>
                <div class="flex flex-col w-full gap-1">
                                        ...
                                        <tr class="bg-slate-900 text-slate-200 font-semibold border-b border-slate-800 hover:bg-slate-800">
                                            ...
                                            <td class="px-6 py-4">
                                                @if($spinWheel->is_winner == 1)
                                                    <span class="text-green-400">Winner</span>
                                                @else
                                                    <span class="text-rose-500">Lose</span>
                                                @endif
                    ...
                    @else
                        <div class="px-10 py-20 items-center justify-center flex flex-col gap-5 bg-slate-900 rounded-xl">
                            ...
                            <h1 class="text-slate-200 font-semibold">No haven't spin yet.</h1>
                            <x-href href="{{ route('spin.wheel') }}" class="!font-semibold">Spin now</x-href>
                        </div>
                    @endif
                </div>
