...
<div wire: id="mpopupBox" class="mpopup fixed h-full top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 max-h-full grid items-center">
    <div class="relative w-full max-w-[640px] max-h-full h-full grid items-center mx-auto">
      <!-- Modal content -->
        <div class="sm:flex flex-none bg-slate-900 rounded-xl p-5 items-center relative">
          <div>
            <div class="rounded-lg border-0">
              ...
              <div class="md:px-6 sm:px-0 py-6 lg:px-8">
                  ...
                  <p class="text-base mb-5 text-gray-600 !font-medium">{{__('Join our subscribers list to get latest news and updates about our promos delivered directly to your inbox')}}.</p>
